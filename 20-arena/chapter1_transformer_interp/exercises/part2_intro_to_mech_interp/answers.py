...
if MAIN:
    ...
    # Maximum context window:       'n_ctx': 1024
...
# %% - attention patterns for layer 0
...
if MAIN:
    ...
    q = gpt2_cache["q", 0] # shape: seq, head_idx, d_head
    k = gpt2_cache["k", 0] # shape: seq, head_idx, d_head
...
def get_log_probs(
    ...
    # reference:
    # 1. https://www.perfectlynormal.co.uk/blog-eindex
    # eindex(logprobs[:, :-1], tokens[:, 1:], "b s [b s]")
